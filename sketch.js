...
function setup() 
{
 ...
 starGame1=createSprite(320,50,20,20);
 starGame1.addImage(starImg);
 starGame1.scale=0.02

 starGame2=createSprite(70,370,20,20);
 starGame2.addImage(starImg);
 starGame2.scale=0.02;

blower=createImg("baloon2.png");
blower.position(240,370);
blower.size(120,120)
blower.mouseClicked(airBlow);
  ...
  starDisplay=createSprite(50,20,10,10);
...
if(collide(fruit,starGame1,20)==true){
  starGame1.visible=false;
  starDisplay.changeAnimation("one")
}
if(collide(fruit,starGame2,20)==true){
  starGame2.visible=false;
